...
public class Auditorium{
    ...
    /**
     * <b>Description:</b> Creates the Chairs objects that fills the Chair matrix.<br>
     * <b>pre: </b> every position in array should correspond to a letter in Alphabet.<br>
     * <b>post: </b> fills the chairs matrix corresponding to the numbers in every position of the array passed as parameter. <br>
     * The larger number in array will be taken as the number of columns of the matrix to be created.<br> 
     * Likewise, the length of array will be the number of rows of the matrix to be created. 
     * @param chairs_per_row integer array, every position corresponds to a letter in the alphabet (that character will be the id of every row) 
     * and the number of that position corresponds to the number of chairs in that row. E.g. if chairs_per_row[0] = 10, 
     * then the row A will contain 10 rows.<br> 
     */
    ...
    public String showChairs(){
        ...
        image +="Number of chairs: " + Chair.getNumberOfObjs() +"\nPerfectage of deficient chairs: " + calculatePercentageOfDeficient();
        return image;
    }
